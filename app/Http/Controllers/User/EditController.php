...
class EditController
{
    ...
    public function update(Request $request, C1answers $datatable){
        $id = $request->input('surname');

        $tiket = DB::table('c1answers');
        ...
        $datatable::where('user_id', $authid)->update(['c1answers' => json_encode($answersc1), 'c2answers' => json_encode($answersc2), 'c3answers' => json_encode($answersc3), 'c4answers' => json_encode($answersc4), 'surname' => $data['surname'], 'midname' => $midname, 'sex' => $sex, 'user_id' => $user_id, 'firstname' => $data['firstname']]);
